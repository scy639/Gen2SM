...
import PIL
from imports import *
from .BaseDatasetWrapper import BaseDatasetWrapper
...
class GsoDatabase(BaseDatabase) :
    ...
    def __init__(self, obj:str,):
        ...
        DATASET_ROOT = os.path.abspath(confs.dataPath_gso)
    ...
    #     elev,azim=R_or_pose__2__elev_azim_inDeg_B(pose34)
    #     return elev,azim
...
class GsoDataset(BaseDatasetWrapper):
