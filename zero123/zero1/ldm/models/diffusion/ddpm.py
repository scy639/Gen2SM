...
class LatentDiffusion(DDPM):
    ...
    def instantiate_first_stage(self, config):
        ...
        self.first_stage_model = model.eval()# : ldm.models.autoencoder.AutoencoderKL
    ...
    def get_input(self, batch, k, return_first_stage_outputs=False, force_c_encode=False,
        ...
        CACHE_ENABLE=confs.cache_4_ldm_get_input.enable
        if CACHE_ENABLE:
            cache_4_ldm_get_input=confs.cache_4_ldm_get_input
        ...
        if CACHE_ENABLE:
            ...
            z=None
        if z is None:
            if kwargs.get ('target_is_z_insteadof_rgb',False):
                z = batch['z_target']
            else:
    ...
    def encode_first_stage(self, x):
        if hasattr(self, "split_input_params"):# :0
            if self.split_input_params["patch_distributed_vq"]:
                ks = self.split_input_params["ks"]  # eg. (128, 128)
                stride = self.split_input_params["stride"]  # eg. (64, 64)
    ...
    def p_losses(self, x_start, cond, t, noise=None,q0_noisePr=None,scy_only_ret_PR=False,**kw):#scy comment all loss_dict related
        ...
        if 1:
            BATCH_multiple_iv = confs.BATCH_multiple_iv
            bIV = confs.bIV
        if 1: # else branch of not BATCH_multiple_iv
