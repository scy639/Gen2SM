...
So I cache it in mem and sue IPC-socket to fetch it when running main program
"""
import socket
import psutil
...
if __name__ == '__main__':
    ...
    import confs
    MemoryCache.run_as_server(path_fileToKeepInMemory=confs.weightPath_zero123)