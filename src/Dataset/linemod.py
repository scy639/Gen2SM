...
LINEMOD_ROOT = root_config.dataPath_linemod
...
class LINEMODDatabase(BaseDatabase) :#from Gen6d
    ...
    def get_elev_azim_inDeg(self,img_id):
        return 0,0
...
class LinemodDataset(BaseDataset):
    ...
    def get_data(self, sequence_name, index0,index1,  q0ipr=0,q1ipr=0, ):
        ...
        images_not_transformed, image_full_paths, rotations, translation31s, pose44s,l_bbox ,Ks,l_elev_deg,l_az_deg=self._get_from_database(index0, index1,q0ipr,q1ipr,)
    ...
    def get_data_4loftr(self, sequence_name, index0,index1, q0ipr=0,q1ipr=0, max_size=None ):
        assert sequence_name=="" or self.__class__.__name__=='Co3dv2Dataset'
        images_not_transformed, image_full_paths, rotations, translation31s,pose44s, l_bbox,Ks,l_elev_deg,l_az_deg=\
    ...
    def get_data_4gen6d(self, sequence_name, ids  ,q0ipr=0,q1ipr=0,):
        ...
        def batch_img_2_batch_img_full_path(batch_img):
            ...
            for i in range(2):
                ...
                full_path = os.path.join(  root_config.dataPath_tmp_batch_images  , f'{tmp_batch_images_subfolderName}/[{root_config.DATASET}][{tmp_cate_or_obj}][{sequence_name}]{img_name_without_suffix}{root_config.tmp_batch_image__SUFFIX}')
